  ...
  return (
    <div className="space-y-6">
      ...
      <section className="rounded-xl border border-hairline bg-surface p-6">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div>
            ...
            <p className="mt-1 max-w-xl text-sm text-content-muted">
              ...
              <strong className="font-medium text-content">guessable</strong>:
          ...
          {canManage && (
            <form action={active ? disablePublicShare : enablePublicShare}>
              ...
              <button
                ...
                className={
                  active
                    ? "rounded-lg border border-danger-border px-4 py-2 text-sm font-medium text-danger hover:bg-danger-soft"
        ...
        {active && (
          <div className="mt-6 space-y-6 border-t border-hairline-subtle pt-6">
            <div>
              ...
              <div className="mt-2 flex flex-wrap items-center gap-2">
                <code
                  className="rounded bg-canvas px-2 py-1 text-xs text-content"
                ...
                <label className="mt-2 flex items-start gap-2 text-sm">
                  ...
                  <span>
                    ...
                    <span className="block text-xs text-content-subtle">
                      ...
                      <code className="rounded bg-surface-muted px-1">noindex</code>{" "}
