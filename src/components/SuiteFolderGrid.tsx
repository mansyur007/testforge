 ...
 * Kalau tidak ada sub-suite, grid ini tidak dirender sama sekali sehingga
 * suite daun tetap langsung memperlihatkan tabel case-nya.
 */
export function SuiteFolderGrid({ folders }: { folders: SuiteFolder[] }) {
